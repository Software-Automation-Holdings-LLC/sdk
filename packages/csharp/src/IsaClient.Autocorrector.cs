// <c>IsaClient.Autocorrector</c> — top-level static factory for the generic
...
// <c>IsaClient.Builder().WithAutocorrector(...)</c>.
using System;
...
public sealed partial class IsaClient
{
    ...
    /// kernel. Reachable as <c>IsaClient.Autocorrector.Create(typoMap)</c>.</summary>
