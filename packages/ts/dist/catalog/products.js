...
export var Product;
(function (Product) {
    Product["FexAetnaAccendo"] = "fex-aetna-accendo";
    Product["FexAetnaProtectionSeries"] = "fex-aetna-protection-series";
    Product["FexAflacFinalExpense"] = "fex-aflac-final-expense";
    Product["FexAmericanAmicableClearChoice"] = "fex-american-amicable-clear-choice";
    Product["FexAmericanAmicableDignitySolutions"] = "fex-american-amicable-dignity-solutions";
    Product["FexAmericanAmicableGoldenSolution"] = "fex-american-amicable-golden-solution";
    Product["FexAmericanAmicableInnovativeSolutions"] = "fex-american-amicable-innovative-solutions";
    Product["FexAmericanAmicablePlatinumSolutionLegacyPlan"] = "fex-american-amicable-platinum-solution-legacy-plan";
    Product["FexAmericanAmicableSeniorChoice"] = "fex-american-amicable-senior-choice";
    Product["FexAmericanAmicableTribute"] = "fex-american-amicable-tribute";
    Product["FexAmericanHomeLifeGuidestar"] = "fex-american-home-life-guidestar";
    Product["FexAmericanHomeLifePatriotSeries"] = "fex-american-home-life-patriot-series";
    Product["FexAmericoEaglePremier"] = "fex-americo-eagle-premier";
    Product["FexBaltimoreLifeIprovide"] = "fex-baltimore-life-iprovide";
    Product["FexBaltimoreLifeSilverGuard"] = "fex-baltimore-life-silver-guard";
    Product["FexBetterlifeFinalExpense"] = "fex-betterlife-final-expense";
    Product["FexCentrianLivingLegacy"] = "fex-centrian-living-legacy";
    Product["FexCicaLifeSuperiorChoice"] = "fex-cica-life-superior-choice";
    Product["FexCignaIndividualWholeLife"] = "fex-cigna-individual-whole-life";
    Product["FexCombinedGenerationalLife"] = "fex-combined-generational-life";
    Product["FexCorebridgeGiwl"] = "fex-corebridge-giwl";
    Product["FexCorebridgeSimplinowLegacy"] = "fex-corebridge-simplinow-legacy";
    Product["FexEmcEasylife"] = "fex-emc-easylife";
    Product["FexEverestIaAmericanAdvantage50Plus"] = "fex-everest-ia-american-advantage-50-plus";
    Product["FexFamilyBenefitLifeGoldenEagle"] = "fex-family-benefit-life-golden-eagle";
    Product["FexFidelityLifeRapidecision"] = "fex-fidelity-life-rapidecision";
    Product["FexFidelityLifeRapidecisionSeniorLife"] = "fex-fidelity-life-rapidecision-senior-life";
    Product["FexFirstGuarantyInsuranceSecurityCare"] = "fex-first-guaranty-insurance-security-care";
    Product["FexForestersPlanRight"] = "fex-foresters-plan-right";
    Product["FexGerberLife"] = "fex-gerber-life";
    Product["FexGpmLifeSecureMark"] = "fex-gpm-life-secure-mark";
    Product["FexGtlHeritagePlan"] = "fex-gtl-heritage-plan";
    Product["FexIllinoisMutualPathProtectorPlus"] = "fex-illinois-mutual-path-protector-plus";
    Product["FexKskjFinalExpense"] = "fex-kskj-final-expense";
    Product["FexLibertyBankersSimpl"] = "fex-liberty-bankers-simpl";
    Product["FexLifeShieldSurvivor"] = "fex-life-shield-survivor";
    Product["FexManhattanLifeSecureAdvantage"] = "fex-manhattan-life-secure-advantage";
    Product["FexMutualOfOmahaLivingPromise"] = "fex-mutual-of-omaha-living-promise";
    Product["FexNewbridgeFinalExpense"] = "fex-newbridge-final-expense";
    Product["FexOccidentalLifeClearChoice"] = "fex-occidental-life-clear-choice";
    Product["FexOccidentalLifeDignitySolutions"] = "fex-occidental-life-dignity-solutions";
    Product["FexOccidentalLifeGoldenSolution"] = "fex-occidental-life-golden-solution";
    Product["FexOccidentalLifeInnovativeSolutions"] = "fex-occidental-life-innovative-solutions";
    Product["FexOccidentalLifePlatinumSolutionLegacyPlan"] = "fex-occidental-life-platinum-solution-legacy-plan";
    Product["FexOccidentalLifeSeniorChoice"] = "fex-occidental-life-senior-choice";
    Product["FexOccidentalLifeTribute"] = "fex-occidental-life-tribute";
    Product["FexOxfordLifeSimplifiedIssue"] = "fex-oxford-life-simplified-issue";
    Product["FexPekinWholeLife"] = "fex-pekin-whole-life";
    Product["FexPioneerAmericanIndependentAmerican"] = "fex-pioneer-american-independent-american";
    Product["FexPioneerAmericanNorthstarLegacy"] = "fex-pioneer-american-northstar-legacy";
    Product["FexRoyalArcanumGraded"] = "fex-royal-arcanum-graded";
    Product["FexRoyalArcanumSimplifiedIssue"] = "fex-royal-arcanum-simplified-issue";
    Product["FexRoyalNeighborsEnsuredLegacy"] = "fex-royal-neighbors-ensured-legacy";
    Product["FexSUsaGoldenPromise"] = "fex-s.usa-golden-promise";
    Product["FexSbliLivingLegacy"] = "fex-sbli-living-legacy";
    Product["FexSecuricoLifeFinalExpense"] = "fex-securico-life-final-expense";
    Product["FexSecurityNationalSimpleSecurity"] = "fex-security-national-simple-security";
    Product["FexSeniorLifeWholeLife"] = "fex-senior-life-whole-life";
    Product["FexSentinelSecurityNewVantage"] = "fex-sentinel-security-new-vantage";
    Product["FexSonsOfNorwayLegacySure"] = "fex-sons-of-norway-legacy-sure";
    Product["FexSonsOfNorwayWholeLife"] = "fex-sons-of-norway-whole-life";
    Product["FexTransamericaFeExpressSolution"] = "fex-transamerica-fe-express-solution";
    Product["FexTransamericaSolution"] = "fex-transamerica-solution";
    Product["FexTrinityGoldenEagle"] = "fex-trinity-golden-eagle";
    Product["FexUnitedFarmAndFamilyWholeLife"] = "fex-united-farm-and-family-whole-life";
    Product["FexUnitedHomeLifeWholeLife"] = "fex-united-home-life-whole-life";
    Product["MedsupAetnaAccendoMedsup"] = "medsup-aetna-accendo-medsup";
    Product["MedsupAetnaMedsup"] = "medsup-aetna-medsup";
    Product["MedsupManhattanLifeMedsup"] = "medsup-manhattan-life-medsup";
    Product["MedsupMutualOfOmahaMedsup"] = "medsup-mutual-of-omaha-medsup";
    Product["PreneedBetterlifeSinglePremium"] = "preneed-betterlife-single-premium";
    Product["PreneedGlobalAtlanticSimpleProtectionPlan"] = "preneed-global-atlantic-simple-protection-plan";
    Product["TermAmericanAmicableEasyTerm"] = "term-american-amicable-easy-term";
    Product["TermAmericanAmicableHomeProtector"] = "term-american-amicable-home-protector";
    Product["TermAmericanAmicableTermMadeSimple"] = "term-american-amicable-term-made-simple";
    Product["TermAmericoHmsPlus"] = "term-americo-hms-plus";
    Product["TermAmeritasFlxLivingBenefitsTerm"] = "term-ameritas-flx-living-benefits-term";
    Product["TermAmeritasValuePlusTerm"] = "term-ameritas-value-plus-term";
    Product["TermBannerOpterm"] = "term-banner-opterm";
    Product["TermCorebridgeSelectATerm"] = "term-corebridge-select-a-term";
    Product["TermFidelityLifeInstabrainPureTerm"] = "term-fidelity-life-instabrain-pure-term";
    Product["TermFidelityLifeInstabrainTerm"] = "term-fidelity-life-instabrain-term";
    Product["TermFidelityLifeInstaterm"] = "term-fidelity-life-instaterm";
    Product["TermForestersStrongFoundation"] = "term-foresters-strong-foundation";
    Product["TermForestersYourTerm"] = "term-foresters-your-term";
    Product["TermForestersYourTermNonMedical"] = "term-foresters-your-term-non-medical";
    Product["TermGpmQMark"] = "term-gpm-q-mark";
    Product["TermGtlTurboTerm"] = "term-gtl-turbo-term";
    Product["TermHeroLifeTerm"] = "term-hero-life-term";
    Product["TermJohnHancockSimpleTermWithVitality"] = "term-john-hancock-simple-term-with-vitality";
    Product["TermKansasCityLifeSignatureTermExpress"] = "term-kansas-city-life-signature-term-express";
    Product["TermLincolnLifeelements"] = "term-lincoln-lifeelements";
    Product["TermLincolnTermaccel"] = "term-lincoln-termaccel";
    Product["TermMutualOfOmahaTermLifeAnswers"] = "term-mutual-of-omaha-term-life-answers";
    Product["TermMutualOfOmahaTermLifeExpress"] = "term-mutual-of-omaha-term-life-express";
    Product["TermNationwideYourlife"] = "term-nationwide-yourlife";
    Product["TermNorthAmericanAddvantage"] = "term-north-american-addvantage";
    Product["TermProsperityFamilyFreedomTerm"] = "term-prosperity-family-freedom-term";
    Product["TermProtectiveLifeClassicChoiceTerm"] = "term-protective-life-classic-choice-term";
    Product["TermProtectiveLifeCustomChoiceTerm"] = "term-protective-life-custom-choice-term";
    Product["TermPrudentialEssentialTermPlus"] = "term-prudential-essential-term-plus";
    Product["TermPrudentialEssentialTermValue"] = "term-prudential-essential-term-value";
    Product["TermSagicorSageTerm"] = "term-sagicor-sage-term";
    Product["TermSbliTTerm"] = "term-sbli-t-term";
    Product["TermSeniorLifeTermLife"] = "term-senior-life-term-life";
    Product["TermTransamericaTrendsetterLb"] = "term-transamerica-trendsetter-lb";
    Product["TermTransamericaTrendsetterSuper"] = "term-transamerica-trendsetter-super";
    Product["TermWilliamPennOpterm"] = "term-william-penn-opterm";
})(Product || (Product = {}));
...
const ALL_PRODUCTS = Object.freeze(Object.values(Product));
function lc(s) {
...
export const Products = Object.freeze({
    ...
    entries() {
        return ALL_PRODUCTS.map((p) => [p, METADATA[p]]);
    },
