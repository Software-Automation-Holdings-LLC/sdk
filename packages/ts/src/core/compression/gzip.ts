 ...
 */
export async function compress(input: string | Uint8Array): Promise<CompressionEnvelope> {
 ...
 */
export async function decompress(envelope: CompressionEnvelope): Promise<string> {
