...
const INDEX_CACHE = new WeakMap<DatasetBundleV3, ReferenceIndex>();
function indexFor(bundle: DatasetBundleV3): ReferenceIndex {
...
): MedicationConcept | UnknownConcept {
...
export function matchCondition(
  text: string,
  bundle: DatasetBundleV3,
): ConditionConcept | UnknownConcept {
 ...
 * Never rejects.
 */
export function matchConcept(text: string, bundle: DatasetBundleV3): Concept {
