...
export async function lookup(ctx: PreferencesContext): Promise<PreferencesLookupResult> {
 ...
 */
function parsePrefsBody(body: string, fallback?: PreferencesDocument): PreferencesDocument {
